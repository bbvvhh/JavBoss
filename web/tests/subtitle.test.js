...
test('formatDurationDelta 描述字幕与视频的时长差', () => {
  ...
  assert.equal(formatDurationDelta(500), '时长一致')
...
test('subtitleLanguageLabel 对空语言给出占位', () => {
  ...
  assert.equal(subtitleLanguageLabel({ language: '  ' }), '未知语言')
