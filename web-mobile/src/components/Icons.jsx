...
const PATHS = {
  ...
  // 喜爱度打分用实心星（star 是描边的，在深色底上看不出「已选中」）。
  starFilled: (
    <path
      d="m12 3.6 2.7 5.5 6 .9-4.35 4.25 1.03 6-5.38-2.83L6.62 20.2l1.03-6L3.3 10l6-.9L12 3.6Z"
      {...FILLED}
  ...
  camera: (
    <>
      <path
        d="M4 8.6A1.6 1.6 0 0 1 5.6 7h1.8l1.2-1.9h6.8L16.6 7h1.8A1.6 1.6 0 0 1 20 8.6v7.8A1.6 1.6 0 0 1 18.4 18H5.6A1.6 1.6 0 0 1 4 16.4V8.6Z"
        {...STROKE}
      />
      <circle cx="12" cy="12.5" r="3.1" {...STROKE} />
    </>
  ),
  shield: (
    <>
